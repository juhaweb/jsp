...
public class TicketVO {
	...
	private String ticket_movie_no;
	private String ticket_movie_date;
	private String ticket_round_view;
	private String ticket_theater_no;
	private String ticket_screen_no;
	...
	public String getTicket_movie_no() {
		return ticket_movie_no;
	}
	public void setTicket_movie_no(String ticket_movie_no) {
	...
	public String getTicket_theater_no() {
		return ticket_theater_no;
	}
	public void setTicket_theater_no(String ticket_theater_no) {
		this.ticket_theater_no = ticket_theater_no;
	}
	public String getTicket_screen_no() {
		return ticket_screen_no;
	}
	public void setTicket_screen_no(String ticket_screen_no) {
